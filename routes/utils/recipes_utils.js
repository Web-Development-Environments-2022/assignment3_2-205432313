...
// async function getRandomDetails(randoms){
//     for (var i=0; i < randoms.length; i++) {
//         console.log(randoms[i].id)
//     }
// }
...
async function IFUserEXIST(username) {
    ...
    var last_watched = await DButils.execQuery(`select username from cakes_db.watchedbyuser `);
...
// exports.getRandomDetails = getRandomDetails;
